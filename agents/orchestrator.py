...
class AgentOrchestrator:
    ...
    async def start_session(
        ...
        # Step 4: Generate VR session (Agent E)
        vr_session = await self.vr_agent.process({
    ...
    async def run_initial_assessment(
        ...
        # Generate VR assessment instructions (Agent E)
        assessment_vr = self.vr_agent.generate_assessment_instructions(
            questions=questions_result.get("questions", []),
            assessment_type="concept_check",
        )
    ...
    async def run_onboarding_assessment(
        ...
        # Generate VR instructions for the assessment
        assessment_vr = self.vr_agent.generate_assessment_instructions(
